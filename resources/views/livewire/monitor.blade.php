<div>
    ...
    <style>
        ...
        <div class="px-4 mx-auto mt-8 max-w-7xl">
            ...
            <div class="flex justify-between p-6 mb-6 bg-white rounded-lg shadow-lg">
                <div class="flex items-start">
                    ...
                    <div class="flex-1">
                        <!-- Nome do equipamento -->
                        <h1 class="text-2xl font-bold text-sky-800">{{$equipamento->nome}} - {{$equipamento->numero_serie}}</h1>

                        <!-- Informações do cliente -->
                        <div class="mt-2">
                            <p class="text-lg text-gray-600">Cliente: {{$equipamento->customer->description}}</p>
                            <p class="text-gray-500">{{$equipamento->customer->address}}</p>
                        </div>
