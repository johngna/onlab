        ...
        <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
            <div class="flex flex-col items-center justify-between p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4">
                ...
                <div class="flex flex-col items-stretch justify-end flex-shrink-0 w-full space-y-2 md:w-auto md:flex-row md:space-y-0 md:items-center md:space-x-3">
                    <x-button type="button" id="createProductModalButton" data-modal-target="createProductModal" data-modal-toggle="createProductModal" label="Novo Usuário" />
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3">{{$u->customer_name}}</td>

                            <td class="px-4 py-3">

                            </td>
                            <td class="flex items-center justify-end px-4 py-3">
                                <x-button type="button" id="createProductModalButton" data-modal-target="createProductModal" data-modal-toggle="createProductModal" label="Editar" wire:click='edit({{$u->id}})' />
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <form wire:submit='save'>
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <!-- mensagem informando que a senha será enviada por email -->
                    ...
                    <div class="sm:col-span-2">
                        <x-input label="Nome" placeholder="Nome Usuário" wire:model='usuario.name' />
                    </div>
                    <div class="sm:col-span-2">
                        <x-input label="Email" placeholder="Email Usuário" wire:model='usuario.email' />
                    </div>
                    <div>
                        <x-input label="Número do Cliente no Auvo" placeholder="Número do Cliente" wire:model='usuario.customer_id' />
                    </div>
                    <div class="flex items-end">
                        <x-button label="Buscar no AUVO" wire:click='getClientAuvo' class="justify-center" />
                    </div>
                    <div class="sm:col-span-2">
                        <x-input label="Nome Cliente" placeholder="Nome Cliente" wire:model='usuario.customer_name' />
                    </div>
