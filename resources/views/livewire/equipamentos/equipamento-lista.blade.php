        ...
        <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
            <div class="flex flex-col items-center justify-between p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4">
                ...
                <div class="flex flex-col items-stretch justify-end flex-shrink-0 w-full space-y-2 md:w-auto md:flex-row md:space-y-0 md:items-center md:space-x-3">
                    <x-button type="button" id="createProductModalButton" data-modal-target="createProductModal" data-modal-toggle="createProductModal" label="Novo Equipamento" />
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white"><a href="{{route('monitor', $equipamento->id)}}"> {{$equipamento->nome}} </a></th>
                            <td class="px-4 py-3">{{$equipamento->numero_serie}}</td>
                            <td class="px-4 py-3">{{$equipamento->customer->description}}</td>
                            <td class="px-4 py-3 max-w-[12rem] truncate">{{$equipamento->customer->address}}</td>
                            <td class="px-4 py-3">
                            ...
                            <td class="flex items-center justify-end px-4 py-3">
                                ...
                                <div id="apple-imac-27-dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                                    <ul class="py-1 text-sm" aria-labelledby="apple-imac-27-dropdown-button">
                                        ...
                                        <li>
                                            <a href="{{route('monitor', $equipamento->id)}}"  class="flex items-center w-full px-4 py-2 text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white dark:text-gray-200">
                                                <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 20 20" fill="currentColor" aria-hidden="true">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <x-select
                            ...
                            option-value="auvoId"
                            wire:model="equipamento.cliente"
                        />
                    </div>
                    {{-- <div>
